        ...
        <TableBody>
          ...
          {!isLoading && apis.map((api) => (
            ...
            >
              ...
              <TableCell><ApiManagementModeBadge mode={api.managementMode} /></TableCell>
              <TableCell className="font-mono text-xs">{api.oaSpec?.latestVersion ?? '—'}</TableCell>
      ...
      <AlertDialog open={!!deleteTarget} onOpenChange={(open) => { if (!open) setDeleteTarget(null) }}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete <strong>{deleteTarget?.name}</strong> and remove it from OpenSearch. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

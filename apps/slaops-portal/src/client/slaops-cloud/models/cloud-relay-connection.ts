...
export type CloudRelayConnectionTypeEnum =
  (typeof CloudRelayConnectionTypeEnum)[keyof typeof CloudRelayConnectionTypeEnum]
...
export type CloudRelayConnectionDeliveryModeEnum =
  (typeof CloudRelayConnectionDeliveryModeEnum)[keyof typeof CloudRelayConnectionDeliveryModeEnum]
export const CloudRelayConnectionSqsQueueModeEnum = {
  Platform: 'platform',
  Relay: 'relay',
} as const

export type CloudRelayConnectionSqsQueueModeEnum =
  (typeof CloudRelayConnectionSqsQueueModeEnum)[keyof typeof CloudRelayConnectionSqsQueueModeEnum]

...
| **url**                 | **string** | URL the platform fetches the spec from (url_fetch strategy only). Must be publicly accessible or reachable from the SLAOps egress IP range.  | [optional] [default to undefined]           |

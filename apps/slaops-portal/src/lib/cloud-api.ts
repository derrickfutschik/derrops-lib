import { Configuration } from '@/client/slaops-cloud'
import { API_BASE_URL } from '@/config'
import { fetchAuthSession } from 'aws-amplify/auth'
import axios from 'axios'

/**
 * Axios instance shared by all generated slaops-cloud API clients.
...
/**
 * Pre-built Configuration for all slaops-cloud API clients.

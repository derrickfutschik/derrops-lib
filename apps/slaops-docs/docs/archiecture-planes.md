...
| ------------------- | ----------------------- | -------- |
| Control Plane       | SLAOps Portal           | SLAOps   |
| Data Plane          | SAAS API                | Vendor   |
| Policy Plane        | Aegis Policy Engine     | Customer |
| Identity Plane      | Customer IdP            | Customer |
| Security Plane      | Token signing / Secrets | SLAOps   |
| Observability Plane | Logs & Audit            | SLAOps   |
| Management Plane    | Aegis/SLAOps Portal     | SLAOps   |

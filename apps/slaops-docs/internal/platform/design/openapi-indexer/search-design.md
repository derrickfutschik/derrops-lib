...
**Mode:** Global Search — **Target:** `slaops--{tenantId}--oaspec--spec--search` (alias)
...
**Mode:** Global Search — **Target:** `slaops--{tenantId}--oaspec--server--search` (alias)
...
**Mode:** Global Search — **Target:** `slaops--{tenantId}--oaspec--operation--search` (alias)
...
**Mode:** Global Search — **Target:** `slaops--{tenantId}--oaspec--param--search` (alias)
...
**Mode:** Global Search — **Target:** `slaops--{tenantId}--oaspec--model--search` (alias)
...
5.   Cache miss →
        a. Global Search: slaops--{tenantId}--oaspec--server--search for matching host shapes
...
6. From specId, resolve operation:
        ...
        b. Cache miss → Global Search: slaops--{tenantId}--oaspec--operation--search

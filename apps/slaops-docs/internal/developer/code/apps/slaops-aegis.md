...
See the [Cloud Relay Component Design](/internal/platform/design/cloud-relay/component-cloud-relay) and [Aegis Token Broker Design](/internal/platform/design/cloud-relay/aegis-token-broker-design) for the full architecture, sequence diagrams, and design decisions.

# Derrops Documentation Site

Docusaurus 3.9.2 documentation site for the Derrops platform, hosted at https://blog.Derrops.com. Part of the Derrops monorepo — use `pnpm` for all package management.
...
- Build shared deps before building docs: `pnpm --filter @derrops/private run build && pnpm --filter @derrops/public run build`.

...
Derrops focuses on logging HTTP requests and responses. There are different levels of support for these types of logs:
...
| Mobile Client Logs  | MOB   | SOON  | Derrops Platform can be used on your own Mobile Client Logs. Using the platform you can generate the view of a consumer of your own Mobile Client   |
| Desktop Client Logs | DESK  | SOON  | Derrops Platform can be used on your own Desktop Client Logs. Using the platform you can generate the view of a consumer of your own Desktop Client |

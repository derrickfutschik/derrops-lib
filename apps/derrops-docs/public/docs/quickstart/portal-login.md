...
sidebar_position: 2
description: Create an Derrops account and explore the Portal for the first time.
tags:
  - quickstart
  - portal
  - authentication
...
This guide walks you through creating an Derrops account and navigating the Portal for the first time.
...
1. Go to [derrops.com](https://derrops.com) and click **Get started**.
...
1. Go to [app.derrops.com](https://app.derrops.com).

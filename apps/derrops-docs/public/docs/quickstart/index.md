...
sidebar_position: 1
description: Step-by-step guides to get Derrops running — from account creation to your first monitored request.
tags:
  - quickstart
  - getting-started
---
...
These guides take you from a fresh account to a fully running Derrops setup as quickly as possible. Each guide is self-contained — follow them in order for a complete setup, or jump to the one you need.

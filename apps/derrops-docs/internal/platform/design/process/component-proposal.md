...
This directory contains component proposals for the Derrops platform. Each proposal follows the [Component Proposal Standard](./component-proposal-standard.md) and uses the [Component Proposal Template](https://github.com/derrickfutschik/derrops-platform/blob/main/COMPONENT_PROPOSAL_TEMPLATE.md).
...
1. Copy the template from the repository root:
   ...
   ```bash
   cp COMPONENT_PROPOSAL_TEMPLATE.md apps/derrops-docs/docs/proposals/my-component-name.md
   ```
...
- [COMPONENT_PROPOSAL_TEMPLATE.md](https://github.com/derrickfutschik/derrops-platform/blob/main/COMPONENT_PROPOSAL_TEMPLATE.md) - Blank template

...
The Cloud Relay is a customer-deployed HTTP proxy that sits between the Derrops portal and the customer's API endpoints. It solves four core problems for API testing: CORS restrictions, inconsistent timing, fixed egress IP requirements, and credential exposure.

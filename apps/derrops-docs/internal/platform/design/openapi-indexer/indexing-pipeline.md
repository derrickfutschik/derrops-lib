...
**Target index:** `derrops--{tenantId}--oaspec--spec`
...
**Target index:** `derrops--{tenantId}--oaspec--server`
...
**Target index:** `derrops--{tenantId}--oaspec--operation`
...
**Target index:** `derrops--{tenantId}--oaspec--param`
...
**Target index:** `derrops--{tenantId}--oaspec--model`

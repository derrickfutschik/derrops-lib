...
implements:
  - apps/derrops-portal/src/components/apis/ModelsTab.tsx
  - apps/derrops-portal/src/hooks/useModelsTab.ts
author: Derrick
status: implemented
tags:
  - openapi-indexer
...
**OpenSearch query** (against `derrops--{tenantId}--oaspec--model`):

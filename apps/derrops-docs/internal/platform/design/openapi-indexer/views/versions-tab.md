...
implements:
  - apps/derrops-portal/src/components/apis/VersionsTab.tsx
  - apps/derrops-portal/src/hooks/useVersionsTab.ts
author: Derrick
status: implemented
tags:
  - openapi-indexer
...
**OpenSearch query** (against `derrops--{tenantId}--oaspec--spec`):

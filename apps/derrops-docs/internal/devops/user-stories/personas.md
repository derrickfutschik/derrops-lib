...
This document outlines the key personas who interact with the Derrops platform, their priorities, and what matters most to them.
...
| **Cloud Relay**      | To make requests to an API Service on behalf of a client | Useability                                                                                                                             | Explore, develop and test against APIs and API specs which Vendors provide                                                                                         |
...
- [Cloud Relay User Stories](./cloud-request-stories)

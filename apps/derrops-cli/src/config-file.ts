...
import { DERROPS_DIR, DEFAULT_PROFILE, getSection, setSection } from './profile-store'

/**
 * ~/.derrops/config — non-sensitive relay configuration, mode 0644.
 *
 ...
 *   platform_url        — derrops-cloud base URL
...
export interface RelayConfig {
  ...
  /** platform — queue is Derrops-owned; relay consumes via Identity Pool credentials.
...
export const CONFIG_FILE = path.join(DERROPS_DIR, 'config')

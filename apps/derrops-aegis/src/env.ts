 ...
 * All configuration in derrops-aegis comes from process.env — no @derrops/config
...
export const env = {
  ...
  platform: {
    /** Base URL of the Derrops platform. Used for the registration handshake. */
    url: process.env.DERROPS_PLATFORM_URL,
    /**
     ...
     */
    registrationToken: process.env.DERROPS_REGISTRATION_TOKEN,
  },

...
export class CreateCloudRelayConnectionDto {
  ...
  @ApiPropertyOptional({
    ...
    default: 'direct',
    description:
      'direct          — derrops-cloud calls relay synchronously.\n' +
      'relay-queue     — derrops-cloud submits to relay queue, polls relay for result.\n' +
      'platform-queue  — relay polls derrops-cloud outbound. Use when relay cannot accept inbound connections.\n' +
  ...
  @ApiPropertyOptional({
    ...
    default: 'platform',
    description:
      'platform — Derrops provisions and owns the SQS FIFO queue. ' +
      'relay    — Customer provisions the queue and grants sqs:SendMessage to the Derrops platform role; provide relay_sqs_queue_url. ' +
  ...
  @ApiPropertyOptional({
    description:
      ...
      'The customer must grant the DerropsSqsPublishRole sqs:SendMessage permission on this queue.',

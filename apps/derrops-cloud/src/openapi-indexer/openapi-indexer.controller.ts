 ...
 *
 * @designDoc apps/derrops-docs/internal/platform/design/openapi-indexer/views/index.md
...
export class OpenApiIndexerController {
  ...
  /**
   * Search the Derrops-managed platform catalogue (global tier, unauthenticated-friendly).

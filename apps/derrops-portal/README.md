...
- This app contains the frontend to the Derrops platform. It is a React application that uses the Vite framework.
- It contains all of the frontend code for the Derrops platform.
- apps/derrops-portal/src/client/derrops-cloud/ is the client for the Derrops platform.

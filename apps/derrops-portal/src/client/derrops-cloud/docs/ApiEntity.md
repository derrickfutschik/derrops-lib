...
**managementMode** | **string** | private  — tenant owns and manages this spec. platform — tenant has adopted a Derrops-managed spec from the global catalogue. | [default to ManagementModeEnum_Private]

...
export interface DerropsClientState {
...
const initialState: DerropsClientState = {
  collapsedSections: {
    apiMatch: false,
    service: false,
    server: false,
...
const derropsClientSlice = createSlice({
  name: 'apiTester',
  initialState,
  reducers: {
...
} = actionRegistry.registerAll(derropsClientSlice.actions, {
  toggleSection: {
...
export const derropsClientReducer = derropsClientSlice.reducer

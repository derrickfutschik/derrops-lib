...
**The portal must be buildable in isolation.** It must never import from other packages in this monorepo (`@derrops/*`, `derrops-cloud`, `derrops-aegis`, etc.).

All backend communication **must** go through the generated OpenAPI client at `src/client/derrops-cloud/`. When the backend API changes, regenerate the client — do not reach into backend source code directly.
...
import { something } from '@derrops/private'
import { helper } from '../../derrops-cloud/src/...'
```
...
**Never declare a local interface or type that mirrors a backend response.** Always import generated models from `src/client/derrops-cloud/models/`.
...
import { SomeModel } from '@/client/derrops-cloud'
...
├── client/
│   └── derrops-cloud/   # Generated OpenAPI TypeScript client (do not edit)
...
```typescript
import { Configuration, ServiceApi } from '@/client/derrops-cloud'
...
The client lives in `src/client/derrops-cloud/` and is auto-generated — **do not edit it manually**. Regenerate when the backend API changes.

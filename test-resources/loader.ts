...
function getDirname(): string {
  // In ESM context (when import.meta is available)
 ...
 */
export const OPENAPI_DIRECTORY_ROOT = join(TEST_RESOURCES_ROOT, 'openapi-directory', 'APIs');
 ...
 * ```
 */
export async function findOpenApiSpecs(pattern?: string): Promise<Array<{
  domain: string;
  subdomain: string;
  version: string;
  path: string;

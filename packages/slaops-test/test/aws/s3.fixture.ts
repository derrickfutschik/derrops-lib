...
const har: HarEntry = {
    ...
    "request": {
        ...
        "headers": [
            ...
            {
                "name": "user-agent",
                "value": "aws-sdk-js/3.940.0 ua/2.1 os/darwin#24.6.0 lang/js md/nodejs#22.21.1 api/s3#3.940.0 m/N,E,n"
            },
            {
                "name": "host",
            ...
            {
                "name": "authorization",
                "value": "AWS4-HMAC-SHA256 Credential=ABCDEFGHIJKLMNOPQRSTUVWXYZ/20251130/us-east-1/s3/aws4_request, SignedHeaders=amz-sdk-invocation-id;amz-sdk-request;host;x-amz-content-sha256;x-amz-date;x-amz-user-agent, Signature=abcdefghijklmnopqrstuvwxyz"
            },
            {

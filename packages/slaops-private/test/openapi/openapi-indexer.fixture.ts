...
export const AWS_S3_LEGACY_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      ...
      base_path: '/',
      server_url: 'https://s3.{region}.amazonaws.com',
    },
  },
]
...
export const AWS_S3_VIRTUAL_HOST_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: '*.s3.*.amazonaws.com',
      base_path: '/',
      server_url: 'https://{bucket}.s3.{region}.amazonaws.com',
    },
  },
  {
    ...
    expected: {
      host_template: '*.s3.*.amazonaws.com',
      base_path: '/v1/files',
      server_url: 'https://{bucket}.s3.{region}.amazonaws.com/v1/files',
    },
  },
]
...
export const AWS_S3_DUALSTACK_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: 's3.dualstack.*.amazonaws.com',
      base_path: '/',
      server_url: 'https://s3.dualstack.{region}.amazonaws.com',
    },
  },
]
...
export const AWS_API_GATEWAY_REST_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: '*.execute-api.*.amazonaws.com',
      base_path: '/',
      server_url: 'https://{restapi-id}.execute-api.{region}.amazonaws.com',
    },
  },
  {
    ...
    expected: {
      host_template: '*.execute-api.*.amazonaws.com',
      base_path: '/prod',
      server_url: 'https://{restapi-id}.execute-api.{region}.amazonaws.com/prod',
    },
  },
]
...
export const AWS_STS_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: 'sts.amazonaws.com',
      base_path: '/',
      server_url: 'https://sts.amazonaws.com',
    },
  },
  {
    ...
    expected: {
      host_template: 'sts.*.amazonaws.com',
      base_path: '/',
      server_url: 'https://sts.{region}.amazonaws.com',
    },
  },
]
...
export const AWS_OPENSEARCH_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: 'search-*.*.es.amazonaws.com',
      base_path: '/',
      server_url: 'https://search-{domain}.{region}.es.amazonaws.com',
    },
  },
]
...
export const AWS_EVENTBRIDGE_PIPES_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: 'pipes.*.amazonaws.com',
      base_path: '/',
      server_url: 'https://pipes.{region}.amazonaws.com',
    },
  },
]
...
export const AWS_BEDROCK_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: 'bedrock-runtime.*.amazonaws.com',
      base_path: '/',
      server_url: 'https://bedrock-runtime.{region}.amazonaws.com',
    },
  },
  {
    ...
    expected: {
      host_template: 'bedrock-agents-runtime.*.amazonaws.com',
      base_path: '/',
      server_url: 'https://bedrock-agents-runtime.{region}.amazonaws.com',
    },
  },
]
...
export const AWS_CLOUDFRONT_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: 'cloudfront.amazonaws.com',
      base_path: '/',
      server_url: 'https://cloudfront.amazonaws.com',
    },
  },
]
...
export const AWS_ECR_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: '*.dkr.ecr.*.amazonaws.com',
      base_path: '/',
      server_url: 'https://{aws_account}.dkr.ecr.{region}.amazonaws.com',
    },
  },
  {
    ...
    expected: {
      host_template: '*.dkr.ecr.*.amazonaws.com',
      base_path: '/',
      server_url: 'https://{account}.dkr.ecr.{region}.amazonaws.com',
    },
  },
]
...
export const AWS_LAMBDA_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: '*.lambda-url.*.on.aws',
      base_path: '/',
      server_url: 'https://{api-id}.lambda-url.{region}.on.aws',
    },
  },
]
...
export const BASE_PATH_CASES: BuildServerDocCase[] = [
  {
    ...
    expected: {
      host_template: 'api.example.com',
      base_path: '/v1/customers',
      server_url: 'https://api.example.com/v1/customers',
    },
  },
  {
    ...
    expected: {
      ...
      server_url: 'https://api.example.com/v1/shipping/customers',
    },
  },
  {
...
export const EDGE_CASES: BuildServerDocCase[] = [
  ...
  },
  {
    ...
    expected: {
      host_template: 'api.example.com',
      base_path: '/v1',
      server_url: 'https://api.example.com:8080/v1',
    },
  },
  {
    ...
    expected: {
      ...
      base_path: '/api',
      server_url: 'https://{service_name}.{environment}.{region}.example.com/api',
    },
  },
  {
    ...
    expected: {
      host_template: '*.*.example.com',
      base_path: '/',
      server_url: 'https://{tenant_id}.{region-code}.example.com',
    },
  },
]
    ...
    servers: [
      {
        ...
        expectedBasePath: '/v1/shipping/customers',
      },
      {
        url: 'https://api.example.com/v1/shipping/orders',
        expectedBasePath: '/v1/shipping/orders',
      },
      {
        url: 'https://api.example.com/v1/shipping/products',
        expectedBasePath: '/v1/shipping/products',
      },
    ],

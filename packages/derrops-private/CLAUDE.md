...
Foundation package for the Derrops platform. Contains core TypeScript types, interfaces, shared constants/enums, and base utility functions used by every other package. Has no dependencies — it is the base of the build graph.
...
import {
  ...
  listAvailableSpecs,
  findSpecs,
} from '@derrops/private/src/test-utils/openapi-loader'

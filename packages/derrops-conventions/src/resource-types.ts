...
export const RESOURCE_TYPES = {
  ...
  cloudwatchLogsGroup: {
    ...
    iamService: 'logs',
    arn: { service: 'logs', includeRegion: true, includeAccount: true, resourcePrefix: 'log-group:' },
    permissions: {
      read: ['logs:Get*', 'logs:List*', 'logs:Describe*', 'logs:Filter*', 'logs:StartQuery', 'logs:StopQuery'],
      readWrite: ['logs:Get*', 'logs:List*', 'logs:Describe*', 'logs:Filter*', 'logs:StartQuery', 'logs:StopQuery', 'logs:Put*', 'logs:Create*', 'logs:Delete*'],
      manage: ['logs:*'],
    },
  },
  ...
  ecr: {
    ...
    wordDelimiter: '-',
    iamService: 'ecr',
    arn: { service: 'ecr', includeRegion: true, includeAccount: true, resourcePrefix: 'repository/' },
    permissions: {
      read: ['ecr:Get*', 'ecr:List*', 'ecr:Describe*', 'ecr:BatchGet*'],
      readWrite: ['ecr:Get*', 'ecr:List*', 'ecr:Describe*', 'ecr:BatchGet*', 'ecr:Put*', 'ecr:InitiateLayerUpload', 'ecr:UploadLayerPart', 'ecr:CompleteLayerUpload', 'ecr:BatchDelete*'],
      manage: ['ecr:*'],
    },
  },
  ecsCluster: {
    ...
    permissions: {
      ...
      readWrite: ['ecs:Describe*', 'ecs:List*', 'ecs:RunTask', 'ecs:StartTask', 'ecs:StopTask', 'ecs:Update*'],
      manage: ['ecs:*'],
    },
  },
  ecsService: {
  ...
  ecsTaskDefinition: {
    ...
    wordDelimiter: '-',
    iamService: 'ecs',
    arn: { service: 'ecs', includeRegion: true, includeAccount: true, resourcePrefix: 'task-definition/' },
    permissions: {
      read: ['ecs:Describe*', 'ecs:List*'],
      readWrite: ['ecs:Describe*', 'ecs:List*', 'ecs:RegisterTaskDefinition', 'ecs:DeregisterTaskDefinition'],
      manage: ['ecs:*'],
    },
  },
  ...
  dynamoDb: {
    ...
    wordDelimiter: '-',
    iamService: 'dynamodb',
    arn: { service: 'dynamodb', includeRegion: true, includeAccount: true, resourcePrefix: 'table/' },
    permissions: {
      read: ['dynamodb:Get*', 'dynamodb:BatchGet*', 'dynamodb:Query', 'dynamodb:Scan', 'dynamodb:Describe*'],
      readWrite: ['dynamodb:Get*', 'dynamodb:BatchGet*', 'dynamodb:Query', 'dynamodb:Scan', 'dynamodb:Describe*', 'dynamodb:Put*', 'dynamodb:Update*', 'dynamodb:Delete*', 'dynamodb:BatchWrite*'],
      manage: ['dynamodb:*'],
    },
  },
  dynamoDbGsi: {
    ...
    arn: { service: 'dynamodb', includeRegion: true, includeAccount: true, resourcePrefix: 'table/', resourceSuffix: '/index/*' },
    permissions: {
      read: ['dynamodb:Get*', 'dynamodb:BatchGet*', 'dynamodb:Query', 'dynamodb:Scan', 'dynamodb:Describe*'],
      readWrite: ['dynamodb:Get*', 'dynamodb:BatchGet*', 'dynamodb:Query', 'dynamodb:Scan', 'dynamodb:Describe*', 'dynamodb:Put*', 'dynamodb:Update*', 'dynamodb:Delete*', 'dynamodb:BatchWrite*'],
      manage: ['dynamodb:*'],
  ...
  lambdaFunction: {
    ...
    wordDelimiter: '-',
    iamService: 'lambda',
    arn: { service: 'lambda', includeRegion: true, includeAccount: true, resourcePrefix: 'function:' },
    permissions: {
  ...
  cloudFrontDistribution: {
    ...
    arn: { service: 'cloudfront', includeRegion: false, includeAccount: true, resourcePrefix: 'distribution/' },
    permissions: {
      read: ['cloudfront:Get*', 'cloudfront:List*', 'cloudfront:Describe*'],
      readWrite: ['cloudfront:Get*', 'cloudfront:List*', 'cloudfront:Describe*', 'cloudfront:Update*', 'cloudfront:CreateInvalidation'],
      manage: ['cloudfront:*'],
    },
  },
  cloudFrontAlias: {
  ...
  sqsQueue: {
    ...
    permissions: {
      ...
      readWrite: ['sqs:Get*', 'sqs:List*', 'sqs:ReceiveMessage', 'sqs:SendMessage', 'sqs:DeleteMessage', 'sqs:ChangeMessageVisibility'],
      manage: ['sqs:*'],
    },
  },
  sqsFifoQueue: {
  ...
  kinesisStream: {
    ...
    wordDelimiter: '-',
    iamService: 'kinesis',
    arn: { service: 'kinesis', includeRegion: true, includeAccount: true, resourcePrefix: 'stream/' },
    permissions: {
  ...
  eventBridgeBus: {
    ...
    wordDelimiter: '-',
    iamService: 'events',
    arn: { service: 'events', includeRegion: true, includeAccount: true, resourcePrefix: 'event-bus/' },
    permissions: {
  ...
  eventBridgeRule: {
    ...
    permissions: {
      read: ['events:Describe*', 'events:List*'],
      readWrite: ['events:Describe*', 'events:List*', 'events:Put*', 'events:Delete*', 'events:Enable*', 'events:Disable*'],
      manage: ['events:*'],
    },
  },
  kafkaTopic: {
  ...
  stepFunctions: {
    ...
    wordDelimiter: '-',
    iamService: 'states',
    arn: { service: 'states', includeRegion: true, includeAccount: true, resourcePrefix: 'stateMachine:' },
    permissions: {
      read: ['states:Describe*', 'states:List*', 'states:Get*'],
      readWrite: ['states:Describe*', 'states:List*', 'states:Get*', 'states:StartExecution', 'states:StopExecution', 'states:SendTaskSuccess', 'states:SendTaskFailure', 'states:SendTaskHeartbeat'],
      manage: ['states:*'],
    },
  },
  ...
  elastiCacheCluster: {
    ...
    arn: { service: 'elasticache', includeRegion: true, includeAccount: true, resourcePrefix: 'cluster:' },
    permissions: {
  ...
  elastiCacheReplicationGroup: {
    ...
    wordDelimiter: '-',
    iamService: 'elasticache',
    arn: { service: 'elasticache', includeRegion: true, includeAccount: true, resourcePrefix: 'replicationgroup:' },
    permissions: {
      read: ['elasticache:Describe*', 'elasticache:List*'],
      readWrite: ['elasticache:Describe*', 'elasticache:List*', 'elasticache:Modify*'],
      manage: ['elasticache:*'],
  ...
  ssmParam: {
    ...
    permissions: {
      ...
      readWrite: ['ssm:GetParameter*', 'ssm:DescribeParameters', 'ssm:PutParameter', 'ssm:DeleteParameter*'],
      manage: ['ssm:*'],
    },
  },
  secretsManager: {
    ...
    arn: { service: 'secretsmanager', includeRegion: true, includeAccount: true, resourcePrefix: 'secret:' },
    permissions: {
      read: ['secretsmanager:GetSecretValue', 'secretsmanager:Describe*', 'secretsmanager:List*'],
      readWrite: ['secretsmanager:GetSecretValue', 'secretsmanager:Describe*', 'secretsmanager:List*', 'secretsmanager:PutSecretValue', 'secretsmanager:UpdateSecret'],
  ...
  appConfigApplication: {
    ...
    arn: { service: 'appconfig', includeRegion: true, includeAccount: true, resourcePrefix: 'application/' },
    permissions: {
      read: ['appconfig:Get*', 'appconfig:List*'],
      readWrite: ['appconfig:Get*', 'appconfig:List*', 'appconfig:Create*', 'appconfig:Update*', 'appconfig:Delete*'],
      manage: ['appconfig:*'],
    },
  },
  ...
  glueDatabase: {
    ...
    wordDelimiter: '_',
    iamService: 'glue',
    arn: { service: 'glue', includeRegion: true, includeAccount: true, resourcePrefix: 'database/' },
    permissions: {
  ...
  glueCrawler: {
    ...
    permissions: {
      read: ['glue:Get*', 'glue:List*'],
      readWrite: ['glue:Get*', 'glue:List*', 'glue:StartCrawler', 'glue:StopCrawler', 'glue:Update*'],
      manage: ['glue:*'],
    },
  },
  athenaWorkgroup: {
    ...
    wordDelimiter: '-',
    iamService: 'athena',
    arn: { service: 'athena', includeRegion: true, includeAccount: true, resourcePrefix: 'workgroup/' },
    permissions: {
      read: ['athena:Get*', 'athena:List*', 'athena:BatchGet*'],
      readWrite: ['athena:Get*', 'athena:List*', 'athena:BatchGet*', 'athena:StartQueryExecution', 'athena:StopQueryExecution'],
      manage: ['athena:*'],
    },
  },
  redshiftCluster: {
  ...
  mskCluster: {
    ...
    wordDelimiter: '-',
    iamService: 'kafka',
    arn: { service: 'kafka', includeRegion: true, includeAccount: true, resourcePrefix: 'cluster/' },
    permissions: {
  ...
  wafWebAcl: {
    ...
    permissions: {
      ...
      readWrite: ['wafv2:Get*', 'wafv2:List*', 'wafv2:Describe*', 'wafv2:Update*', 'wafv2:Associate*', 'wafv2:Disassociate*'],
      manage: ['wafv2:*'],
    },
  },
  backupPlan: {
  ...
  backupVault: {
    ...
    wordDelimiter: '-',
    iamService: 'backup',
    arn: { service: 'backup', includeRegion: true, includeAccount: true, resourcePrefix: 'backup-vault:' },
    permissions: {
      read: ['backup:Describe*', 'backup:List*', 'backup:Get*'],
      readWrite: ['backup:Describe*', 'backup:List*', 'backup:Get*', 'backup:StartBackupJob', 'backup:StartRestoreJob', 'backup:Delete*'],
      manage: ['backup:*'],
    },
  },
  xraySamplingRule: {
